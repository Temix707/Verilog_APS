...
set rt::rc [catch {
  uplevel #0 {
    ...
    set ::env(RT_TMP) "C:/Vivado_project/RISC_V_main_decoder/.Xil/Vivado-9192-T7/realtime/tmp"
    ...
    if {$rt::useElabCache == false} {
      rt::read_verilog -include C:/Vivado_project/RISC_V_main_decoder/RISC_V_main_decoder.srcs/sources_1/new {
...
# MODE: 
    ...
    rt::set_parameter enableSplitFlowPath "C:/Vivado_project/RISC_V_main_decoder/.Xil/Vivado-9192-T7/"
