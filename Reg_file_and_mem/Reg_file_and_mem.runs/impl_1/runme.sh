...
HD_PWD='C:/Vivado_project/Reg_file_and_mem/Reg_file_and_mem.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_rf.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source alu_rf.tcl -notrace
