...
HD_PWD='C:/Vivado_project/Reg_file_and_mem/Reg_file_and_mem.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log alu_rf.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source alu_rf.tcl
