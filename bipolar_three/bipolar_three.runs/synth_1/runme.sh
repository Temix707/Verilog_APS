...
HD_PWD='C:/Vivado_project/bipolar_three/bipolar_three.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log top_bip_3l.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source top_bip_3l.tcl
